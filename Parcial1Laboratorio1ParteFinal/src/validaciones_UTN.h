...
int validacionNumeroEntero(int* entero, char mensaje[]);


/*brief valida numeros enteros largos "%ld", si se ingresa otra cosa pide que vuelvas a ingresar.
 * param1 el numero a validar, y al que se le asignara lo ingresado al final.
 * return retorna 0 si funciono sin problemas.
 * */
...
/*brief valida numeros float entre el minimo y el maximo, si se ingresa otra cosa pide que vuelvas
 * a ingresar.
 * param1 el numero a validar, y al que se le asignara lo ingresado al final.
 * param2 es el minimo numero que puede ingresar.
 * param3 es el maximo numero que puede ingresar.
 * return retorna 0 si funciono sin problemas.
 * */
int validacionFloatConMinMax(float* entero, float minimo, float maximo, char mensaje[]);
...
/*brief valida que lo ingresado sea menor a 11 caracteres ya que un cuil cuenta con 11 caracteres , si es mayor pide que
 vuelvas a ingresar.
 * param1 variable pasada por referencia donde se guardara el string despues de validarlo.
 * param2 mensaje con el cual se pide la entrada de datos especifica.
 * return retorna 0 si no hubo errores y -1 si no pudo validad.
